...
output = sorted(num_friends_by_id,
...
print(max(most_common_interests_with(users[0])))
print(interests_by_user_id[0])
print(interests_by_user_id[max(most_common_interests_with(users[0]))])
